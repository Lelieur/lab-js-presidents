...
function getNames(presidentsArr) {
  ...
  const names = presidentsArr.map(eachPresident => {
...
function getDemocraticPresidents(presidentsArr) {
  ...
  const democraticPresidents = presidentsArr.filter(eachPresident => {
...
function sortPresidentsByBirthYear(presidentsArr) {
  ...
  const sortPresidentsByBirthYear = presidentsArr.sort((a, b) => {
    return a.birthYear - b.birthYear
  })

  return sortPresidentsByBirthYear
...
function getAgeAtInauguration(presidentsArr) {
  ...
  const ageAtInauguration = presidentsArr.map(eachPresident => {

    const age = eachPresident.tookOffice - eachPresident.birthYear
...
function getPresidentsBornAfter(presidentsArr, year) {
  ...
  const presidentsBornAfter = presidentsArr.filter(eachPresident => {
...
function countRepublicanPresidents(presidentsArr) {
  ...
  presidentsArr.forEach(eachPresident => {
    if (eachPresident.party === "Republican") {
      eachPresident.party = 1
    }
  })

  const totalRepublicanPresidents = presidentsArr.reduce((acc, eachPresident) => {

    if (eachPresident.party !== 1) {
      return acc
    }

    if (eachPresident.party === 1) {

      return acc + eachPresident.party
    }
...
function sortPresidentsByName(presidentsArr) {
  ...
  const presidentsByName = presidentsArr.sort((a, b) => {
    if (a.name < b.name) {
      return -1
    }
    if (a.name > b.name) {
